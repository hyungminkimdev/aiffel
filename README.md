...
*저도 어렸을 때 아이언맨 영화를 보며 자비스가 있으면 정말 좋겠다 생각했는데 이걸 실천으로 옮긴 저커버그가 대단하다는 생각이 드네요.* 
...
*오픈 AI의 GPT 성장 속도가 엄청난 것 같습니다. GPT-4o도 굉장히 기대가 됩니다.*
...
*AI를 하나의 툴로써 가장 잘 활용할 수 있는 방법에 대한 고찰이 필요할 것 같네요. 또한 윤리적인 문제와 사회 경제적 변화에 민감하게 반응할 준비를 해야할 것 같아요.*
